...
export async function androidXrGuide(topic: string): Promise<string> {
...
`;
  ...
  if (t.includes("setup") || t.includes("depend") || t.includes("install")) return setup;
  if (t.includes("spatial") || t.includes("panel") || t.includes("orbiter") || t.includes("subspace")) return spatialUi;
  if (t.includes("arcore") || t.includes("face") || t.includes("hand") || t.includes("plane") || t.includes("ar ")) return arcore;
  if (t.includes("compat") || t.includes("fallback") || t.includes("non-xr") || t.includes("emulat")) return deviceCompat;
